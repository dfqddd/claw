#!/bin/bash
# mx_select_stock 配置脚本

echo "🔑 mx_select_stock - 妙想智能选股 API Key 配置"
echo ""
echo "注意：mx_select_stock 与 mx_search/mx_data 共用同一个 API Key"
echo ""
echo "请选择配置方式:"
...
case $choice in
    1)
        ...
        echo ""
        echo "🔍 测试连接..."
        python3 scripts/mx_select_stock.py --test
        ;;
    2)
        echo "请编辑 .env 文件，添加:"
